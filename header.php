...
<link href="assets/img/favicon.png" rel="icon">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="dashboard.php">Movies Seat Reservation System<span>.</span></a></h1>
        ...
        <ul>
         ...
         <?php
          ...
          if(!isset($_SESSION['uid'])){
            ...
            <li><a class="nav-link scrollto" href="alltheater.php">Cinema Hall </a></li>
            ...
            $type = $_SESSION['type'];
             if($type == 2){
              ...
              <li><a class="nav-link scrollto" href="alltheater.php">Movie Hall</a></li>
